...
DATASET_NAME = "deployedApps/feedback_dataset"
...
def app():
    ...
    def save_feedback(feedback_data):
        ...
        try:
            ...
            df = pd.concat([dataset, df], ignore_index=True)
        except Exception:
            pass  # No existing dataset
    ...
    with tab1:
        ...
        st.markdown("""
            ...
            **Sample Input:** The inputs can be like "Give me images of Gerald Coetzee Travelling", "Images of players travelling".
        """)
        ...
        if st.button("Submit Query⏩"):
            ...
            if user_query:
                try:
                    ...
                    # Extract filter values from parsed_query
                    ...
                    # Extract number of results from query (default: 6)
                    ...
                    result_urls = filter_images_by_tags(
                        df, query_player_name, query_photographer, query_date, query_time_of_day, query_focus,
                        query_shot_type, query_event_type, query_mood, query_action, query_apparel, query_sublocation
                    )
